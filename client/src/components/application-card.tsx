...
export function ApplicationCard({
  ...
  const [imgSrc, setImgSrc] = useState(
    application.property.photoUrls?.[0] || '/placeholder.png'
  );
  ...
  return (
    <div className='border rounded-xl overflow-hidden shadow-sm bg-white mb-4'>
      <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between px-6 md:px-4 py-6 gap-6 lg:gap-4'>
        ...
        <div className='hidden lg:block border-[0.5px] border-r-primary-200 h-48' />

        {/* Status Section */}
        <div className='flex flex-col justify-between w-full lg:basis-1/12 lg:h-48 py-2 gap-3 lg:gap-0'>
          <div>
