...
const PropertyTenants = () => {
  ...
  const { data: leases, isLoading: isLeasesLoading } =
  ...
  if (isPropertyError || isPaymentsError) {
    ...
    <div className='dashboard-container'>
      ...
      <div className='w-full space-y-6'>
        <div className='mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6'>
          ...
          <hr className='mt-4 mb-1 opacity-15' />

          <div className='overflow-x-auto'>
            <Table>
              <TableHeader>
                <TableRow className='border-gray-300'>
                  <TableHead>Tanant</TableHead>
              ...
              <TableBody>
                {leases?.map((lease) => (
                  <TableRow key={lease.id} className='h-24 border-gray-300'>
                    <TableCell>
